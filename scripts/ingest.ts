#!/usr/bin/env tsx
/**
 * Namibia Law MCP -- Census-Driven Ingestion Pipeline (AfricanLII Scraping)
 *
 * Reads data/census.json (produced by census.ts via AfricanLII scraping)
 * and fetches + parses every ingestable Act directly from namiblii.org.
 *
 * Features:
 ...
 *
 * Data source: namiblii.org (AfricanLII / Laws.Africa Peachjam platform)
...
const SOURCE_LABEL = 'namiblii.org (AfricanLII direct scraping)';
