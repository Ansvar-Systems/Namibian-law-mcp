#!/usr/bin/env tsx
/**
 * Namibia Law MCP -- Census Script (Laws.Africa API)
 *
 * Enumerates ALL acts for Namibia from the Laws.Africa Content API
 ...
 * E.g. "/akn/na/act/2000/2" -> "na-act-2000-2"
 */
