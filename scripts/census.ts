#!/usr/bin/env tsx
/**
 * Namibia Law MCP -- Census Script (AfricanLII Direct Scraping)
 *
 * Scrapes the legislation listing pages from namiblii.org to enumerate
 * ALL acts. Writes data/census.json in golden standard format.
 *
 * No API key required -- scrapes the public listing pages directly.
 *
 * Source: https://namiblii.org/legislation
 * Note: namiblii.org does NOT use the /en/ prefix (unlike tanzlii/ulii).
 *
 * Usage:
...
const JURISDICTION = 'NA';
const JURISDICTION_NAME = 'Namibia';
const PORTAL = 'https://namiblii.org';
const LISTING_BASE = 'https://namiblii.org/legislation';
const AKN_PATH_PREFIX = '/akn/na/';
 ...
 * namiblii.org uses /akn/na/ paths (no /en/ prefix).
 */
