...
**The Namibia Law alternative for the AI age.**

[![npm version](https://badge.fury.io/js/%40ansvar/namibia-law-mcp.svg)](https://www.npmjs.com/package/@ansvar/namibia-law-mcp)
[![MCP Registry](https://img.shields.io/badge/MCP-Registry-blue)](https://registry.modelcontextprotocol.io)
[![License](https://img.shields.io/badge/License-Apache_2.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)
[![GitHub stars](https://img.shields.io/github/stars/Ansvar-Systems/Namibia-law-mcp?style=social)](https://github.com/Ansvar-Systems/Namibia-law-mcp)
[![CI](https://github.com/Ansvar-Systems/Namibia-law-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/Ansvar-Systems/Namibia-law-mcp/actions/workflows/ci.yml)
...
Query **494 Namibian Acts** -- from the Data Protection Act and Computer Misuse and Cybercrimes Act to the Companies Act, Constitution of Namibia, and more -- directly from Claude, Cursor, or any MCP-compatible client.
...
Namibian legal research is scattered across Namibia Law Reports, the Namibia Gazette, and various government portals. Whether you're:
- A **lawyer** validating citations in a brief or contract under Namibian law
- A **compliance officer** checking if the Data Protection Act 2019 provisions apply to your processing activities
- A **legal tech developer** building tools on Namibian legislation
...
**Endpoint:** `https://namibia-law-mcp.vercel.app/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add namibia-law --transport http https://namibia-law-mcp.vercel.app/mcp` |
...
```json
{
  "mcpServers": {
    "namibia-law": {
      "type": "url",
      "url": "https://namibia-law-mcp.vercel.app/mcp"
    }
  }
}
```
...
- *"What does the Constitution of Namibia say about the right to privacy?"*
- *"Search for data breach notification requirements in Namibian law"*
- *"What are the obligations under the National Payment Systems Act?"*
- *"Validate this legal citation"*
- *"Build a legal stance on personal data processing in Namibia"*
...
| **Namibia Information and Communications Act** | 1998 (amended) | Regulates telecommunications and ICT sector; establishes the Communications Authority of Namibia |
...
| **Constitution of Namibia** | 2010 | Supreme law; Article 31 guarantees the right to privacy |
...
**Estimated database size:** ~80-150 MB (full corpus of Namibian federal legislation)
...
| `format_citation` | Format citations per Namibian conventions (full/short/pinpoint) |
...
| Tool | Description |
|------|-------------|
| `get_eu_basis` | Get EU directives/regulations for Namibian statute |
| `get_namibian_implementations` | Find Namibian laws implementing EU act |
| `search_eu_implementations` | Search EU documents with Namibian implementation counts |
...
- All statute text is ingested from official Namibian government sources
...
- **[Namibia Law Reports](https://namibialaw.org)** -- Official Namibian government legal database
...
>
> Statute text is sourced from official Namibian government publications. However:
...
```bash
git clone https://github.com/Ansvar-Systems/Namibia-law-mcp
cd Namibia-law-mcp
npm install
npm run build
npm test
...
**30+ national law MCPs** covering Australia, Brazil, Canada, China, Denmark, Finland, France, Germany, Ghana, Iceland, India, Ireland, Israel, Italy, Japan, Namibia, Netherlands, Nigeria, Norway, Singapore, Slovenia, South Korea, Sweden, Switzerland, Thailand, UAE, UK, and more.
...
```bibtex
@software{namibia_law_mcp_2025,
  author = {Ansvar Systems AB},
  title = {Namibian Law MCP Server: AI-Powered Legal Research Tool},
  year = {2025},
  url = {https://github.com/Ansvar-Systems/Namibia-law-mcp},
  note = {Namibian legal database with full-text search and EU cross-references}
}
```
...
- **Statutes & Legislation:** Namibian Government (public domain)
