...
**Endpoint:** `https://mcp.ansvar.eu/law-na/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add namibian-law --transport http https://mcp.ansvar.eu/law-na/mcp` |
...
```json
{
  "mcpServers": {
    "namibian-law": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/law-na/mcp"
    }
  }
}
```
