# Namibia Law MCP Server — Developer Guide
...
Namibia Law MCP server providing Namibian legislation search via Model Context Protocol. Strategy A deployment (Vercel, bundled SQLite DB). Covers data protection, cybercrimes, ICT, companies, consumer protection, and other key Acts.
...
- Namibia uses "Section N" for Acts and "Article N" for the Constitution
...
1. `scripts/ingest.ts` -> fetches from Namibia Law -> JSON seed files in `data/seed/`
...
- **Namibia Law** (namibialaw.org) -- National Council for Law Reporting
- **License:** Government Open Data
- **Languages:** English (en) is the primary legal language; Swahili (sw) for some documents
- **Coverage:** All Acts of Parliament, subsidiary legislation, Constitution of Namibia 2010, selected case law

## Namibia-Specific Notes

- Namibia uses a common law legal system inherited from British colonial administration
- The Constitution of Namibia 2010 is the supreme law (Article 2)
...
- For the Constitution: "Article N, Constitution of Namibia 2010"
...
- npm package: `@ansvar/namibia-law-mcp` with bin entry for stdio
